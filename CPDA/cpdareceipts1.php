...
<div>
<nobr><h4>	<?php $qs = "start=$mysqlStart&end=$mysqlEnd&amount=$given_amount&id=".$_GET['id']."";?><a href='acctcpdasum1.php?<?php echo $qs;?>' >AccountSum</a> | <a href='cpdareceipts1.php?<?php echo $qs;?>'><span style="background-color:#F6EECC">ReceiptDetails</span></a>  |  <a href='cpdaexpenditure1.php?<?php echo $qs;?>'>ExpenditureDetails</a>  |  <a href='cpdacommit1.php?<?php echo $qs;?>'> CommitmentDetails </a> </h4></nobr></div>
<table  border="1" width="90%" align="center">
  ...
  <tr>
    ...
    <th><div align="center">RPTCODE</div></th>
...
$cmsum=number_format($cmsum,2);
  $sqlquery1="SELECT RcptDate,RcptNo,RcptCode,Remarks,RcptAmount FROM expenditure_details WHERE StaffNo LIKE '".$instid1."' AND RcptDate BETWEEN '".$mysqlStart."' AND '".$mysqlEnd."'  order by RcptDate "; 
...
<p><ul>
  <li><a href="batch1.php?StaffNo=<?php echo $_REQUEST['id'];?>">CPDA HOME PAGE</a></li>
</ul></p>
<p><ul><li><a href="acctcpdaresult.php">CPDA RESULT PAGE</a></li></ul></p>
<div id="footer">
</div>
</div>
</div>
