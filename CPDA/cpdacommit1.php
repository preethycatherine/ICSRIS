...
<nobr><h4>	<?php $qs = "start=$mysqlStart&end=$mysqlEnd&amount=$given_amount&id=".$_GET['id']."";?><a href='acctcpdasum1.php?<?php echo $qs;?>' >AccountSum</a> | <a href='cpdareceipts1.php?<?php echo $qs;?>'>ReceiptDetails</a>  |  <a href='cpdaexpenditure1.php?<?php echo $qs;?>'>ExpenditureDetails</a>  |  <a href='cpdacommit1.php?<?php echo $qs;?>'><span style="background-color:#F6EECC"> CommitmentDetails </span></a> </h4></nobr></div>
