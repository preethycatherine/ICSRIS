...
<table width="649" border="1" align="center">
  <tr>
    ...
    <th width="108">StaffNo</td>

	<th width="100">BatchStartDate</td>  
	<th width="88">BatchEndDate</td>  
	<th width="108">Given Amount</td>  
	<th width="108">Prevailing Amount</td>  
	<th width="99">Amount Spent </td>  
	<th width="106">Balance</td>  
		<th width="106">summary</td>  
...
//	<td align=center>".$mysqlEnd."</td><td align=right>$given_amount</td><td align=right>$prevailing_amount</td><td align=right>($pcf->total-$pcf1->total1)+$pcf2->total2</td><td align=right>$balance</td><td><a href='acctcpdasum.php?amount=$prevailing_amount&start=$mysqlStart&end=$mysqlEnd&id=".$_GET['StaffNo']."'>summary </a></td>
...
//  </tr>" ;
  ?>
	...
	<td align="center"><?php echo "<a href='acctcpdasum1.php?amount=$prevailing_amount&start=$mysqlStart&end=$mysqlEnd&id=".$_GET['StaffNo']."'>summary </a>"?></td>  
  </tr>
  <?php
