		...
		<div id="primaryContentContainer">
			<div id="primaryContent">
					<?php
						...
						$fname="download/Bill_Address_UnReg.xls";
						$excel=new ExcelWriter($fname);
						if($excel==false)	echo $excel->error;	
						
						$myArr=array("<b>S.No</b>","<b>Vendor Name</b>","<b>ADDRESS</b>","<b>District </b>","<b>State</b>","<b>PINCODE</b>","<b>Contact Person</b>","<b>Email</b>","<b>Contact No</b>","<b>CREATEDBY</b>");
				...
				<div align="center"><strong>Billing Address - Un- Registered</strong></div>
					<table  border="1">
					<tr><td height="27" colspan="7" align="right">Click <a href="<?php echo $fname; ?>" ><b>here</a></b> to Download Excel </td></tr>
						...
						else
						{
							...
							$sqlconnect=odbc_connect($dsn,$username,$password) or die("ODBC CONNECTION 1 Failed");
								...
								$strsql_inv="Select * from GST_BILL_TO_DETAILS_vendor order by DINP";
								...
								while(odbc_fetch_row($process_inv))
								{
									...
									echo "<td align='left'><a href=http://icsris.iitm.ac.in/ICSRIS/admin/Billing_address_gstin_ur_edit.php?bill_id=$bill_id><b>$vendor_name</b></td>";
									...
									echo "<td><a href='remove_vendor.php?bill_id=$bill_id&type=U' onClick='OpenPopup2(this.href); return false' style='text-decoration:underline'><font color='orange'><b>Remove</b></font></a></td>";
									echo "</tr>";
									
									$myArr=array($sno,$vendor_name,odbc_result($process_inv,"ADDRESS"),odbc_result($process_inv,"DISTRICT"),odbc_result($process_inv,"STATE"),odbc_result($process_inv,"PINCODE"),odbc_result($process_inv,"CONTACTPERSON"),odbc_result($process_inv,"EMAIL"),odbc_result($process_inv,"CONTACTNO"),odbc_result($process_inv,"CREATEDBY"));
									$excel->writeLine($myArr);
