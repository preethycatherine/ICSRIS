...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@iitm.ac.in";
    ...
    * @var string
    */
	protected $_base_dn = "DC=iitm,DC=ac,DC=in"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("10.24.3.51");
    ...
    * @var string
    */
protected $_ad_username=secicsr;
protected $_ad_password="GUp97VH6!";
