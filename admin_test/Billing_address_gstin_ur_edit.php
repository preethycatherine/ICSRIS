...
<div id="outer">
	...
	<div id="primaryContent">
		...
		else
		{
			...
			{
				$up_bill_sql="update GST_BILL_TO_DETAILS_vendor set NAME='".$_POST['NAME']."',ADDRESS='".$_POST['ADDRESS']."',DISTRICT='".$_POST['DISTRICT']."',PINCODE='".$_POST['PINCODE']."',STATE='".$_POST['bill_state']."',CONTACTPERSON='".$_POST['CONTACTPERSON']."',EMAIL='".$_POST['EMAIL']."',CONTACTNO='".$_POST['CONTACTNO']."' where bill_id='$bill_id'";
			...
			$strsql="";
			$strsql="Select * from GST_BILL_TO_DETAILS_vendor where Bill_ID='$bill_id'";
			$process=odbc_exec($sqlconnect,$strsql);
			if (odbc_fetch_row($process))
			{
				?>
				<form name='Billing_address_gstin_ur_edit' action='Billing_address_gstin_ur_edit.php' method='POST'  onSubmit="return validate()" enctype="multipart/form-data">
				<div align="center">
				<table style="background-color:#F6EECC" width="100%" >
				<tr>
				<th colspan=5 ><div align=right><span style="color:#CC0000"><a href="Billing_address_gstin.php">Home - Billing Details - Un_Registered (Without GSTIN)</a></span></div></th>
				</tr>
				</table>
				<tr>
