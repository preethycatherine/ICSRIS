...
<script type="text/javascript">
  ...
  function windowpop1(url, width, height) 
	...
	{
		var comp="",date="";
		gstin_pan=document.acctcon_inv_reg_mod1.gstin_pan.value;
		v_district=document.acctcon_inv_reg_mod1.v_district.value;
		
		self.location='acctcon_inv_reg_mod1.php?gstin_pan=' + gstin_pan + '&v_district=' + v_district;  
			// alert (val1);
	}	
	</script>
<style type="text/css">
...
exit;
	...
	if (odbc_fetch_row($process) && ($pono==1))
	{
		...
		$sac_no="";
		?>
		<form name='acctcon_inv_reg_mod1' action='acctcon_inv_reg_mod1.php' method='POST'  onSubmit="return validate()" enctype="multipart/form-data">
		<div align="center">
		...
		<table style="background-color:#F6EECC" width="100%" border="1" >
		<tr>
			<th colspan="4" align="left"><div align="center"><span style="color:#663300">Enter GSTIN Number :&nbsp;&nbsp;</span><input type="text" name="gstin_pan" value="<?php if(isset($_POST['gstin_pan'])) echo $_POST['gstin_pan']; ?>"   /><input type="submit" name="submit" id="submit" value="Get Details" /> &nbsp;&nbsp;
		...
		if ((isset($_POST['submit']) && ($_POST['submit'] == "Get Details")) || isset($_GET['gstin_pan']) || isset($_POST['gstin_pan']) || isset($_SESSION['gstin_pan'])) 
		{	
			odbc_close_all();
			$strsql_gst="";
			...
			<th colspan="4" align="left"><div align="left"><span style="color:#663300">Choose Vendor District:&nbsp;&nbsp;
				...
				odbc_close_all();
				$strsql_district="";
				$strsql_district="Select * from GST_BILL_TO_DETAILS where gstin like '".$_GET['gstin_pan']."%' order by district";
			...
			?>
				 ...
				 ?>
					<tr>
					<th colspan="4"><div align="center"><span style="color:#663300">Choose GSTIN Number to get details</span></div></th>
					</tr>	
				 <?php
				 }
		   }
