...
if(isset($_COOKIE["PHPSESSID"]))
{
	...
	if($_SESSION['invoice_type']=="") $_SESSION['invoice_type']=$_GET['inv_type'];
	...
	if (odbc_fetch_row($process))
	{
		...
		$html = '
		<table><tr><td align="right"> Original<br><img src="images/logo_iitm.jpg"></td></tr></table>
		';
		...
		<tr>
		<th colspan="2"><div align="left"><span style="color:#663300"> CGST (9%)</span></div></th>
		...
		<th><div align="left"> 2722101001741</div></th>
		</tr>
		<tr>
