...
<div id="outer">
	...
	<div id="primaryContent">
		...
		else
		{
			...
			{
				?>
				<form name='acctcon_inv_mod_export' action='acctcon_inv_mod_export.php' method='POST'  onSubmit="return validate()" enctype="multipart/form-data">
				<div align="center">
				...
				<th colspan="2" align="left">			
					...
					odbc_close_all();
					$strsql_v_country="";
					$strsql_v_country="Select * from GST_BILL_TO_DETAILS_EXPORT order by name";
				...
				<th colspan="2" align="left">
					<select name='curr_type'>
						...
						<?php } else { ?><option value="<?php echo odbc_result($process,"Currency_Type"); ?>"><?php echo odbc_result($process,"Currency_Type");  ?></option>
				...
				<input type="text" name="tax_value" value="<?php if(isset($_POST['tax_value'])) echo $tax_value=$_POST['tax_value']; else echo $tax_value=odbc_result($process,"TaxableValue"); ?>"   /><input type="submit" name="submit" id="submit" value="Calculate" /></th>
				</tr>
				<?php
				...
				{	
						...
						?>
							...
							<?php
								...
								{
									$up_inv_sql="update GST_Invoice_Details set Description='".$_POST['desc_service']."',TaxableValue=".$_POST['tax_value'].",CGSTAmount=$CGST,SGSTAmount=$SGST,IGSTAmount=$IGST,TotalInvoiceValue=$total_value,Currency_Type='".$_POST['curr_type']."',Communication_Address='".$_POST['comm_address']."' where InvoiceNumber='$invoice_number'";
									odbc_close_all();
