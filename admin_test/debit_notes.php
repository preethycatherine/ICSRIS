		...
		<div id="primaryContentContainer">
			<div id="primaryContent">
					<?php
						...
						$myArr=array("<b>S.No</b>","<b>Debit Note Number</b>","<b>Invoice Number</b>","<b>Project Number</b>","<b>Invoice Amount</b>","<b>Debit Note Amount</b>","<b>Debit Note Date</b>","<b>Narration</b>");
						$excel->writeLine($myArr);
					?>
					<div align="center"><strong>Submitted Debit Notes</strong></div>
					<table  border="1">
					<tr><td height="27" colspan="8" align="right">Click <a href="<?php echo $fname; ?>" ><b>here</a></b> to Download Excel </td></tr>
						<tr>
						<th width="10">S#</th>
						<!--<th width="15">Select</th> -->
						<th><div align="center" >Debit Note Number </div></th>
						<th><div align="center" >Invoice Number </div></th>
						<th><div align="center" >Project Number </div></th>
						<th><div align="center" >Debit Note Amount</div></th>
						<th><div align="center" >Debit Note Date</div></th>
						...
						else
						{
							...
							$sqlconnect=odbc_connect($dsn,$username,$password) or die("ODBC CONNECTION 1 Failed");
								...
								$strsql_recpt="Select * from GST_Debit_Note_Details a, GST_Invoice_Details b where a.Invoicenumber=b.Invoicenumber order by a.DINP";
								$process_recpt=odbc_exec($sqlconnect,$strsql_recpt) or die("<br>Connection Failed");
								while(odbc_fetch_row($process_recpt))
								{
									$DebitNoteNumber=odbc_result($process_recpt,"DebitNoteNumber");
									...
									$DebitNoteAmount=odbc_result($process_recpt,"DebitNoteAmount");
									$DebitNoteDate=odbc_result($process_recpt,"DebitNoteDate");
									$Narration=odbc_result($process_recpt,"Narration");
									
									
									echo "<tr>";
									echo "<td align='center'>$sno</td>";
									echo "<td align='center'><a href='acctcon_debitnote_rep.php?DebitNoteNumber=$DebitNoteNumber&invoice_type=$invoice_type'><b>$DebitNoteNumber</b></td>";
									echo "<td align='center'>$InvoiceNumber</td>";
									echo "<td align='center'>$ProjectNumber</td>";
									echo "<td align='center'>$Amount</td>";
									echo "<td align='center'>$DebitNoteDate</td>";
									echo "<td align='center'>$Narration</td>";		
									echo "</tr>";
									
									$myArr=array($sno,$DebitNoteNumber,$InvoiceNumber,$ProjectNumber,$invoice_amount,$DebitNoteAmount,$DebitNoteDate,$Narration);
									$excel->writeLine($myArr);
