...
$strsql_inv="Select * from GST_Invoice_Details a, GST_BILL_TO_DETAILS b where a.BillToID=b.bill_id and a.InvoiceType='Registered' order by a.DINP";
...
odbc_close_all();
$sqlconnect=odbc_connect("FACCTGSTDSN","sa","IcsR@123#") or die("ODBC CONNECTION FAILED");
$strsql_inv="Select * from GST_Invoice_Details a, GST_BILL_TO_DETAILS_VENDOR b where a.BillToID=b.bill_id and a.InvoiceType='Un-Registered' order by a.DINP";
$process_inv=odbc_exec($sqlconnect,$strsql_inv) or die("<br>Connection Failed");
$c=2;$sno=1;
while(odbc_fetch_row($process_inv))
{
...
odbc_close_all();
$sqlconnect=odbc_connect("FACCTGSTDSN","sa","IcsR@123#") or die("ODBC CONNECTION FAILED");
$strsql_inv="Select * from GST_Invoice_Details a, GST_BILL_TO_DETAILS_export b where a.BillToID=b.bill_id and a.InvoiceType='Export' order by a.DINP";
$process_inv=odbc_exec($sqlconnect,$strsql_inv) or die("<br>Connection Failed");
$c=2;$sno=1;
while(odbc_fetch_row($process_inv))
{
...
odbc_close_all();
$sqlconnect=odbc_connect("FACCTGSTDSN","sa","IcsR@123#") or die("ODBC CONNECTION FAILED");
$strsql_inv="Select * from GST_Invoice_Details a, GST_BILL_TO_DETAILS b where a.BillToID=b.bill_id and a.InvoiceType='Exempted' order by a.DINP";
$process_inv=odbc_exec($sqlconnect,$strsql_inv) or die("<br>Connection Failed");
$c=2;$sno=1;
while(odbc_fetch_row($process_inv))
{
...
header('Content-Disposition: attachment;filename="Invoices_Over_All.xls"');
