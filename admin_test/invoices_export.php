		...
		<div id="primaryContentContainer">
			<div id="primaryContent">
					...
					<?php
						...
						$fname="download/invoices_export.xls";
						$excel=new ExcelWriter($fname);
						if($excel==false)	echo $excel->error;	
						
						$myArr=array("<b>S.No</b>","<b>Invoice Date</b>","<b>Invoice Number</b>","<b>Project Number</b>","<b>PI Name</b>","<b>DeptName</b>","<b>Description of Services</b>","<b>Currency Type</b>","<b>Taxable Value</b>","<b>CGST (9%)</b>","<b>SGST (9%)</b>","<b>IGST (18%)</b>","<b>Total Invoice Value</b>","<b>SACNumber</b>","<b>Biller Name</b>","<b>Address</b>","<b>Country</b>","<b>Contact Person</b>","<b>Email</b>","<b>Contact No</b>");
					...
					<div align="center"><strong>Submitted Invoices - Export</strong></div>
					<table  border="1">
						...
						else
						{
							...
							$sqlconnect=odbc_connect($dsn,$username,$password) or die("ODBC CONNECTION 1 Failed");
								...
								while(odbc_fetch_row($process_inv))
								{
									...
									$myArr=array($sno,$inv_date,$inv_no,$ProjectNumber,$PIName,odbc_result($process_inv,"DeptName"),odbc_result($process_inv,"Description"),odbc_result($process_inv,"Currency_Type"),odbc_result($process_inv,"TaxableValue"),odbc_result($process_inv,"CGSTAmount"),odbc_result($process_inv,"SGSTAmount"),odbc_result($process_inv,"IGSTAmount"),odbc_result($process_inv,"TotalInvoiceValue"),odbc_result($process_inv,"SACNumber"),odbc_result($process_inv,"NAME"),odbc_result($process_inv,"ADDRESS"),odbc_result($process_inv,"COUNTRY"),odbc_result($process_inv,"CONTACTPERSON"),odbc_result($process_inv,"EMAIL"),odbc_result($process_inv,"CONTACTNO"));
									$excel->writeLine($myArr);
