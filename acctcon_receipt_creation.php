						...
						if($_POST['amount']=="" or $_POST['mode']=="" or $_POST['ref_no']=="" or $_POST['date_receipt']=="") 
						{
						 ...
						 else
						 {
								...
								if (date('m') <= 3) {//Upto June 2014-2015
									...
									//echo $financial_year;
									//$curr_year=date('y');  $financial_year="1718";//$curr_year.($curr_year+1);
								$Receipt_number="";
								...
								if(!odbc_fetch_row($process_recp)) $Receipt_number="C".substr($invoice_number,1,4).substr($invoice_number,9)."P1";
								else
								{
										$last_inv_no="";
										...
										$Receipt_number="C".substr($invoice_number,1,4).substr($invoice_number,9)."P".$last_rec_no;
								}
									...
									require_once('../mail/mail.php');
										...
										$mail->Body = "	Dear Sir/Madam,<br><br>
											...
											<table border=1 width=400>
												...
												<tr align='center' ><td>Payment Mode</td><td>&nbsp;&nbsp;:&nbsp;&nbsp;</td><td> ".$_POST['mode']."</td></tr>
										...
										$mail->AddAddress($to, "");
										$mail->AddCC("icsraccounts8@iitm.ac.in", "");
