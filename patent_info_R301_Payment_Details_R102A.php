				...
				<div id="primaryContent">
					...
					<div align="center">
						...
						if ( !isset( $_COOKIE[ "PHPSESSID" ] ) ) {
							...
							$strsql1 = "SELECT FileNo,Title,Applcn_no,convert(nvarchar(10),Filing_dt,103) as Filing_dt,Inventor1,Department,Pat_no,convert(nvarchar(10),Pat_dt,103) as Pat_dt FROM PatDetails WHERE FileNo LIKE '$ret'";	
...
//						?>
						...
						<table border="1" width="100%">
							...
							<?php 
							odbc_close_all();
							$strsql = "SELECT convert(nvarchar(10),PaymentOrChequeDt,103) as PaymentOrChequeDt,CostGroup,Activity,InvoiceNo,convert(nvarchar(10),InvoiceDt,103) as InvoiceDt,PaymentRefOrChequeNo,PType,Party,dbo.udf_NumberToCurrency(PaymentAmtINR,'IND') as amount FROM PatentPayment WHERE FileNo like '$ret' ";
