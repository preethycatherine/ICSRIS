...
else
{
	...
	else
	{
		...
		$sqlquery="select * from FoxOffice..pmaster where SUBSTRING(APRLNO,0,12) not in (select SUBSTRING(NPRNO,0,12) from MSTLST) and instid=$insid  and (substring(APRLNO,3,4) in ('0203','0304','0405','0506','0607','0708','0809','0910','1011','1112','1213','1314','1415','1516','1617','1718'))";
