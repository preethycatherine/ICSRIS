...
//						?>
						...
						<table border="1" width="100%">
							...
							<?php 
							odbc_close_all();
							$strsql = "SELECT PaymentOrChequeDt,CostGroup,Activity,InvoiceNo, convert(nvarchar(10),InvoiceDt,103)   as InvoiceDt,PaymentRefOrChequeNo,PType,Party,dbo.udf_NumberToCurrency(PaymentAmtINR,'IND') as amount FROM PatentPayment WHERE FileNo like '$ret' ";
