...
<nobr><h4>	<a href="acctrmfsum.php" >AccountSum</a> | <a href="rmfreceipts.php">ReceiptDetails</a>  |  <a href="rmfvoucher.php"><span style="background-color:#F6EECC">ExpenditureDetails</span></a>  |  <a href="rmfstafcommit.php"><u>StafCommitmentDetails</u></a> |  <a href="rmfcommit.php"><u>OthersCommitmentDetails</u></a> </h4></nobr></div>
...
$strsq1="select CONVERT(varchar,vrdate,105) 'DATE',vrno,partyname,purpose,head,amount from rmfvr where irno like '$instid' order by vrdate";
//echo "$strsq1";
