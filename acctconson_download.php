...
/************** SHEET 1 **************/
	...
	// Rename sheet
	$objPHPExcel->getActiveSheet()->setTitle('Consultancy_On_Going_As_PI');
	...
	// Rename sheet
	$objPHPExcel->getActiveSheet()->setTitle('Consultancy_On_Going_As_CO-PI');
...
header('Content-Disposition: attachment;filename="Consultancyon.xls"');
