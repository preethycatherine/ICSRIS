...
<div id="outer">
	...
	<div id="content">
		<div id="primaryContentContainer">
			<div id="primaryContent"><div align="center">
						<h3> Sponsored Closed Projects </h3></div>
					<div align="right"><table  width="100%"><tr><td  align="right">Download in <a href="acctsponcl_download.php" target="_blank">Excel</a></tr></table></div>
<div align="center">
...
$process=odbc_exec($sqlconnect,$sqlquery) or die("Query Execution Failed"); 
//echo "$insid | $usermode";
$i="1";
$ii="2";
...
echo "<td>$i</td>";
//echo "<td align=center><input name=pono type=radio value=$pono /></td>";
echo "<td><a href=http://icsris.iitm.ac.in/ICSRIS/acctspsum.php?nprno=$pono>$pono</a></td>";
echo "<td>$start_date</td>";
echo "<td>$close_date</td>";
//echo "<td align = right >$pramount</td>";
