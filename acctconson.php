...
<div id="content">
	<div id="primaryContentContainer">
		<div id="primaryContent">			
			...
			<div align="right"><table  width="100%"><tr><td  align="left"><a href="display_files.php" target="_blank">NIL TDS Certificates  2018 - 19</a></td><td  align="right">Download in <a href="acctconson_download.php" target="_blank">Excel</a></td></tr></table></div>
<div align="center">
...
<th><div align="center" >Start </th>
<th> Close Date</div></th>
...
echo "<td align='center'>$start_date </td><td>$close_date</td>";
...
echo "<td align = right >".IND_money_format_no_dec(round($exptot))."</td>";
echo "<td align = right >".IND_money_format_no_dec(round($balance))."</td>";
//if($_SESSION['instid']==8190)
//{
...
echo "<td align = right >".IND_money_format_no_dec($balance)."</td>";
	...
	//echo "<a href=acctcon_inv_select.php?cprno=$pono>CreateNew</a></td>";
//echo "<td><a href=acctcon_inv.php?cprno=$pono>Create</a></td>";

	echo "<a href=acctcon_inv_select.php?cprno=$pono><font color=red><strong>Create New</strong></font></a><br><br>";
	if($flag==1) echo "<a href=invoices.php?projectnumber=$pono target='_blank'><font color=green><strong>Prev. Invoices</strong></font></a></td>";
