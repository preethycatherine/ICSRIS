				...
				<div id="primaryContent">
					...
					<div align="center">
						...
						//$strsql1 = "SELECT title,type,InitialFiling,firstApplicant,secondApplicant,request_dt,Specification FROM PatDetails WHERE fileno LIKE '$ret'";	
								$strsql1 = "SELECT title,type,InitialFiling,firstApplicant,secondApplicant,convert(date,request_dt,103) as request_dt FROM PatDetails WHERE fileno LIKE '$ret'";
