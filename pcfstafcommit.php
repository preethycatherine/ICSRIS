...
<nobr><h4>	<a href="acctpcfsum.php" >AccountSum</a> | <a href="pcfreceipts.php">ReceiptDetails</a>  |  <a href="pcfvoucher.php">ExpenditureDetails</a>  |  <a href="pcfstafcommit.php"><span style="background-color:#F6EECC"> StafCommitmentDetails </span></a> |  <a href="pcfcommit.php"><u>OthersCommitmentDetails</u></a> </h4></nobr></div>
...
$strsql="select CONVERT(varchar,inpdt,105) 'DATE',comno,partyname,purpose,head,amount from corpcomt where iirno like '$instid'  and head like 'staf' and amount>0 order by inpdt";
