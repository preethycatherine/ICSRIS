...
<div>
<nobr><h4>	<a href="acctrmfsum.php" ><span style="background-color:#F6EECC">AccountSum</span></a> | <a href="rmfreceipts.php">ReceiptDetails</a>  |  <a href="rmfvoucher.php">ExpenditureDetails</a>  |  <a href="rmfstafcommit.php"><u>StaffCommitmentDetails</u></a> |  <a href="rmfcommit.php"><u>OthersCommitmentDetails</u></a> </h4></nobr>
</div>
<?php
//die();
odbc_close_all();
$strsql="";
$strsql="select sum(amount) as rt from rmfrt where irno like '$instid1'";
...
$strsql="";
$strsql="SELECT sum(amount) as vstaf FROM RMFVR where [check] like 'u' and head like 'staf' and irno like '$instid1'";
//echo "$strsql";
...
odbc_close_all();
$strsql="";
$strsql="SELECT sum(amount) as vcons FROM RMFVR where [check] like 'u' and head like 'cons' and irno like '$instid1'";
//echo "$strsql";
$process1=odbc_exec($sqlconnect,$strsql) or die("<br> Connectin failed at cons voucher level");
if(odbc_fetch_row($process1))
{
...
$strsql="";
$strsql="SELECT sum(amount) as vcont FROM RMFVR where [check] like 'u' and head like 'CONT' and irno like '$instid1'";
...
$strsql="";
$strsql="SELECT sum(amount) as veqpt FROM RMFVR where [check] like 'u' and head like 'EQPT' and irno like '$instid1'";
...
$strsql="";
$strsql="SELECT sum(amount) as vfrtr FROM RMFVR where [check] like 'u' and head like 'FRTR' and irno like '$instid1'";
...
$strsql="";
$strsql="SELECT sum(amount) as vintr FROM RMFVR where [check] like 'u' and head like 'INTR' and irno like '$instid1'";
...
$strsql="";
$strsql="SELECT sum(amount) as vothr FROM RMFVR where [check] like 'u' and head like 'OTHR' and irno like '$instid1'";
///echo "$strsql";
...
$strsql="";
$strsql="select sum(amount) as cstaf from rmfcommit where head like 'STAF' and irno like '$instid1'";
//echo "$strsql";
...
$strsql="";
$strsql="select sum(amount) as ccons from rmfcommit where head like 'CONS' and irno like '$instid1'";
$process1=odbc_exec($sqlconnect,$strsql) or die("<br> Connectin failed at cons commit level");
if(odbc_fetch_row($process1))
{
...
$strsql="";
$strsql="select sum(amount) as ccont from rmfcommit where head like 'CONT' and irno like '$instid1'";
...
$strsql="";
$strsql="select sum(amount) as ceqpt from rmfcommit where head like 'EQPT' and irno like '$instid1'";
...
$strsql="";
$strsql="select sum(amount) as cfrtr from rmfcommit where head like 'FRTR' and irno like '$instid1'";
...
$strsql="";
$strsql="select sum(amount) as cintr from rmfcommit where head like 'INTR' and irno like '$instid1'";
...
$strsql="";
$strsql="select sum(amount) as cothr  from rmfcommit where head like 'OTHR' and irno like '$instid1'";
$process1=odbc_exec($sqlconnect,$strsql) or die("<br> Connectin failed at othr voucher level");
if(odbc_fetch_row($process1))
{
