...
<nobr><h4>	<a href="acctrmfsum.php" >AccountSum</a> | <a href="rmfreceipts.php">ReceiptDetails</a>  |  <a href="rmfvoucher.php">ExpenditureDetails</a>  |  <a href="rmfstafcommit.php"><span style="background-color:#F6EECC">StafCommitmentDetails </span></a> | <a href="rmfcommit.php">OthersCommitmentDetails</a> </h4></nobr></div>
...
$strsql="select CONVERT(varchar,date,105) 'DATE',comno,pono,item,head,amount from rmfcommit where irno like '$instid'  and head like 'staf' and amount>0 order by date";
//echo "$strsql";
