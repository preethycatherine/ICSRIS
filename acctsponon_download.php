...
/************** SHEET 1 **************/
	...
	// Rename sheet
	$objPHPExcel->getActiveSheet()->setTitle('Sponsored_On_Going');
	...
	// Rename sheet
	$objPHPExcel->getActiveSheet()->setTitle('Sponsored_On_Going_CO-PI');
...
header('Content-Disposition: attachment;filename="Sponsoredon.xls"');
