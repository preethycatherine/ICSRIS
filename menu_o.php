	...
	<div class="navbar">
	  ...
	  <div class="dropdowno">
		...
		<div class="dropdowno-content">	
			 <div class="dropdowno">
				<button class="dropbtn"><strong>Sponsored Projects</strong> 
				  
				</button>
				<div class="dropdowno-content">
					 <a href="acctsponon.php">Ongoing Projects</a>
					 <a href="acctsponcl.php">Closed Projects</a>
					 
				<button class="dropbtn"><strong>Consultancy Projects</strong> 
				 
				</button>
					 <a href="acctconson.php">Ongoing Projects</a>
					 <a href="acctconscl.php">Closed Projects</a>
