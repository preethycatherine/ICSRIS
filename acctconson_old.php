...
<th width="20%" ><div align="center" >Start <br /> & <br /> Close Date</div></th>
...
$sqlquery="select cprno,s_date,c_date,c_cost from cmstlst where instid like '$insid' and (c_date>=CAST(CAST(GETDATE() AS DATE) AS DATETIME) OR (C_DATE IS NULL AND SUBSTRING(CPRNO,1,2) LIKE 'TT')) and (substring(cprno,3,4) in ('0203','0304','0405','0506','0607','0708','0809','0910','1011','1112','1213','1314','1415','1516','1617','1718')) order by c_date asc";
...
echo "<td align='center'>$start_date <br>to<br>$close_date</td>";
...
//{
	...
	echo "<a href=http://icsris.iitm.ac.in/ICSRIS/acctcon_inv_select.php?cprno=$pono><font color=red><strong>Create New</strong></font></a><br><br>";
	if($flag==1) echo "<a href=http://icsris.iitm.ac.in/ICSRIS/invoices.php?projectnumber=$pono><font color=green><strong>Prev. Invoices</strong></font></a></td>";
//}
echo "</tr>";
$i++;
}
...
echo "<td align='center'>$start_date <br>to<br>$close_date</td>";
//echo "<td>$close_date</td>";
echo "<td>".IND_money_format_no_dec($pramount)."</td>";
...
//echo "<td><a href=http://icsris.iitm.ac.in/ICSRIS/acctcon_inv.php?cprno=$pono>Create</a></td>";

	echo "<a href=http://icsris.iitm.ac.in/ICSRIS/acctcon_inv_select.php?cprno=$pono><font color=red><strong>Create New</strong></font></a><br><br>";
	if($flag==1) echo "<a href=http://icsris.iitm.ac.in/ICSRIS/invoices.php?projectnumber=$pono target='_blank'><font color=green><strong>Prev. Invoices</strong></font></a></td>";
