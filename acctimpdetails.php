...
<tr  class="rowA">
<th><div align="center"><span style="color:#663300"><?php  echo $_SESSION['name']; ?></span></div></th>
</tr>
</tr >
<tr class="rowB">
...
<div align="right"><table  width="100%"><tr><td  align="right">Download in <a href="acctimpdetails_download.php" target="_blank">Excel</a></tr></table></div>
...
$sql="EXEC [Imprest].[dbo].[InternalSiteLatestClosingBalance]@AccountNo = N'$bankacctno',	@todate = N'$ed'";
...
if (odbc_fetch_row($processc))
{
	...
	$transMonthyear=odbc_result($processc,"tm");
}
