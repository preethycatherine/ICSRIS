...
<body>
<form id="form1" name="form1" method="post" action="acctpcfresult.php">
<?php
...
<div align="center"><h3>PCF ACCOUNTS REPORT SCREEN</h3></div>
<?php
if (!isset($_COOKIE["PHPSESSID"])) 
{
...
//$insid=$_SESSION['instid'];
$sqlquery="select distinct(iirno) as iirno from co_nme order by iirno";
...
{
$INSTID = odbc_result($process,"iirno");
...
<?php
odbc_close_all();
$sqlquery1="select distinct(name) as pname from co_nme where name <> '' order by name";
...
$sqlquery2="select distinct(dept) as dept from co_nme where dept <> '' order by dept";
